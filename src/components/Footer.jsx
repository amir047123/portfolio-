...
import Developer from "./Developer";
import logo from "../assets/Developer/amir faysal-logo.png"
// import Loading from "../Loading/Loading";
// import PrimaryUrl from "../../Config/PrimaryUrl";
      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div class="col-span-2 md:col-span-3 lg:col-span-2 ">
			...
			<img
          className="w-20 rounded-md h-20 object-contain  ring-1 -mt-14 shadow-lg shadow-primary"
          src={logo}
          alt=""
        />
              <h2>
        ...
        <p class="text-sm text-center text-white">
          © Copyright 2023, All Rights Reserved by Amir Faysal
        </p>
      </div>
    </section>
  );
