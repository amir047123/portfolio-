...
var require_react2 = __commonJS({
  "node_modules/typewriter-effect/dist/react.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t(require_react()) : typeof define == "function" && define.amd ? define("Typewriter", ["react"], t) : typeof exports == "object" ? exports.Typewriter = t(require_react()) : e.Typewriter = t(e.react);
      ...
      var t = { 7403: (e2, t2, r2) => {
        ...
        function _(e3) {
          return _ = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e4) {
            return typeof e4;
          } : function(e4) {
        ...
        function x(e3) {
          return function(e4) {
            ...
            if (e4) {
              ...
              return r3 === "Object" && e4.constructor && (r3 = e4.constructor.name), r3 === "Map" || r3 === "Set" ? Array.from(e4) : r3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r3) ? j(e4, t3) : void 0;
            }
          }(e3) || function() {
        ...
        function T(e3) {
          ...
          return _(t3) === "symbol" ? t3 : String(t3);
        }
        const S = function() {
          function e3(t4, r4) {
            var _2 = this;
            if (function(e4, t5) {
              ...
              return typeof _2.options.strings == "string" ? (_2.typeString(_2.options.strings).pauseFor(_2.options.pauseFor), _2) : (_2.options.strings.forEach(function(e4) {
                _2.typeString(e4).pauseFor(_2.options.pauseFor).deleteAll(_2.options.deleteSpeed);
              }), _2);
            }), O(this, "typeString", function(e4) {
              var t5 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
              if (a(e4))
                return _2.typeOutHTMLString(e4, t5);
              if (e4) {
                var r5 = (_2.options || {}).stringSplitter, n3 = typeof r5 == "function" ? r5(e4) : e4.split("");
              ...
              var t5 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, r5 = arguments.length > 2 ? arguments[2] : void 0, n3 = function(e5) {
              ...
              if (n3.length > 0)
                for (var o3 = 0; o3 < n3.length; o3++) {
                  ...
                  a2 && a2.nodeType !== 3 ? (a2.innerHTML = "", _2.addEventToQueue(v, { node: a2, parentNode: t5 }), r5 ? _2.pasteString(i2, a2) : _2.typeString(i2, a2)) : a2.textContent && (r5 ? _2.pasteString(a2.textContent, t5) : _2.typeString(a2.textContent, t5));
                }
              return _2;
            }), O(this, "deleteAll", function() {
              var e4 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "natural";
              ...
              var r5 = arguments.length > 2 && arguments[2] !== void 0 && arguments[2];
              ...
              var r5 = arguments.length > 2 && arguments[2] !== void 0 && arguments[2], n3 = arguments.length > 3 ? arguments[3] : void 0, o3 = { eventName: e4, eventArgs: t5 || {} };
              ...
              if (_2.state.eventLoop = o2()(_2.runEventLoop), !_2.state.eventLoopPaused) {
                ...
                if (!(t5 <= (r5 = a2.eventName === p || a2.eventName === u ? _2.options.deleteSpeed === "natural" ? i(40, 80) : _2.options.deleteSpeed : _2.options.delay === "natural" ? i(120, 160) : _2.options.delay))) {
                  ...
                  switch (_2.logInDevMode({ currentEvent: a2, state: _2.state, delay: r5 }), g3) {
                    ...
                    case s:
                      ...
                      _2.options.onCreateTextNode && typeof _2.options.onCreateTextNode == "function" && (S2 = _2.options.onCreateTextNode(E2, T2)), S2 && (O2 ? O2.appendChild(S2) : _2.state.elements.wrapper.appendChild(S2)), _2.state.visibleNodes = [].concat(x(_2.state.visibleNodes), [{ type: "TEXT_NODE", character: E2, node: S2 }]);
                      break;
                    case u:
                    ...
                    case p:
                      ...
                      if (_2.state.visibleNodes.length) {
                        ...
                        _2.options.onRemoveNode && typeof _2.options.onRemoveNode == "function" && _2.options.onRemoveNode({ node: q, character: B }), q && q.parentNode.removeChild(q), H === m && I && n3.unshift({ eventName: p, eventArgs: {} });
                      }
                      break;
                    case d:
        ...
        function u(e3) {
          var t3 = -1, r3 = e3 == null ? 0 : e3.length;
        ...
        e2.exports = function(e3, t2) {
          for (var r2 = -1, n2 = e3 == null ? 0 : e3.length, o2 = 0, a = []; ++r2 < n2; ) {
            var i = e3[r2];
            t2(i, r2, e3) && (a[o2++] = i);
          }
          return a;
        ...
        e2.exports = function(e3, t3) {
          ...
          for (var y in e3)
            !t3 && !c.call(e3, y) || v && (y == "length" || l && (y == "offset" || y == "parent") || f && (y == "buffer" || y == "byteLength" || y == "byteOffset") || s(y, h)) || d.push(y);
          return d;
        };
      }, 2488: (e2) => {
        e2.exports = function(e3, t2) {
        ...
        e2.exports = function(e3, t2) {
          for (var r2 = -1, n2 = e3 == null ? 0 : e3.length; ++r2 < n2; )
            if (t2(e3[r2], r2, e3))
              return true;
          return false;
        };
        ...
        e2.exports = function(e3) {
          return e3 == null ? e3 === void 0 ? "[object Undefined]" : "[object Null]" : i && i in Object(e3) ? o2(e3) : a(e3);
        };
      }, 9454: (e2, t2, r2) => {
        var n2 = r2(4239), o2 = r2(7005);
        e2.exports = function(e3) {
          return o2(e3) && n2(e3) == "[object Arguments]";
        };
      }, 939: (e2, t2, r2) => {
        var n2 = r2(2492), o2 = r2(7005);
        e2.exports = function e3(t3, r3, a, i, s) {
          return t3 === r3 || (t3 == null || r3 == null || !o2(t3) && !o2(r3) ? t3 != t3 && r3 != r3 : n2(t3, r3, a, i, e3, s));
        };
      }, 2492: (e2, t2, r2) => {
        ...
        e2.exports = function(e3) {
          ...
          for (var r3 in Object(e3))
            a.call(e3, r3) && r3 != "constructor" && t3.push(r3);
          return t3;
        };
      }, 2545: (e2) => {
        e2.exports = function(e3, t2) {
        ...
        e2.exports = function(e3, t3, r3, a, i, s) {
          ...
          for (var y = u; ++l < p; ) {
            ...
            if (!(_ === void 0 ? b === m || i(b, m, r3, a, s) : _)) {
              h = false;
              break;
            }
            y || (y = f == "constructor");
          ...
          if (h && !y) {
            ...
            g == w || !("constructor" in e3) || !("constructor" in t3) || typeof g == "function" && g instanceof g && typeof w == "function" && w instanceof w || (h = false);
          }
          return s.delete(e3), s.delete(t3), h;
        };
      }, 1957: (e2, t2, r2) => {
        var n2 = typeof r2.g == "object" && r2.g && r2.g.Object === Object && r2.g;
        e2.exports = n2;
      }, 8234: (e2, t2, r2) => {
        ...
        e2.exports = function(e3, t3) {
          var r3 = e3.__data__;
          return n2(t3) ? r3[typeof t3 == "string" ? "string" : "hash"] : r3.map;
        };
      }, 852: (e2, t2, r2) => {
        ...
        var n2 = r2(4963), o2 = r2(479), a = Object.prototype.propertyIsEnumerable, i = Object.getOwnPropertySymbols, s = i ? function(e3) {
          return e3 == null ? [] : (e3 = Object(e3), n2(i(e3), function(t3) {
            return a.call(e3, t3);
          }));
        } : o2;
        e2.exports = s;
        ...
        (n2 && g(new n2(new ArrayBuffer(1))) != d || o2 && g(new o2()) != p || a && g(a.resolve()) != l || i && g(new i()) != f || s && g(new s()) != v) && (g = function(e3) {
          var t3 = u(e3), r3 = t3 == "[object Object]" ? e3.constructor : void 0, n3 = r3 ? c(r3) : "";
          if (n3)
            switch (n3) {
              case h:
                return d;
        ...
        e2.exports = function(e3) {
          var t3 = this.__data__;
          return n2 ? t3[e3] !== void 0 : o2.call(t3, e3);
        };
      }, 1866: (e2, t2, r2) => {
        var n2 = r2(4536);
        e2.exports = function(e3, t3) {
          var r3 = this.__data__;
          return this.size += this.has(e3) ? 0 : 1, r3[e3] = n2 && t3 === void 0 ? "__lodash_hash_undefined__" : t3, this;
        };
      }, 5776: (e2) => {
        var t2 = /^(?:0|[1-9]\d*)$/;
        e2.exports = function(e3, r2) {
          var n2 = typeof e3;
          return !!(r2 = r2 == null ? 9007199254740991 : r2) && (n2 == "number" || n2 != "symbol" && t2.test(e3)) && e3 > -1 && e3 % 1 == 0 && e3 < r2;
        };
      }, 7019: (e2) => {
        e2.exports = function(e3) {
          var t2 = typeof e3;
        ...
        e2.exports = function(e3) {
          ...
          return e3 === (typeof r2 == "function" && r2.prototype || t2);
        };
      }, 7040: (e2) => {
        e2.exports = function() {
        ...
        var n2 = r2(1957), o2 = typeof self == "object" && self && self.Object === Object && self, a = n2 || o2 || Function("return this")();
        e2.exports = a;
      }, 619: (e2) => {
        e2.exports = function(e3) {
        ...
        e2.exports = function(e3) {
          return e3 != null && o2(e3.length) && !n2(e3);
        };
      }, 4144: (e2, t2, r2) => {
        e2 = r2.nmd(e2);
        ...
        (function() {
          var t2, r2, n2, o2, a, i;
          typeof performance != "undefined" && performance !== null && performance.now ? e2.exports = function() {
            return performance.now();
          } : typeof process != "undefined" && process !== null && process.hrtime ? (e2.exports = function() {
            return (t2() - a) / 1e6;
        ...
        for (var n2 = r2(75), o2 = typeof window == "undefined" ? r2.g : window, a = ["moz", "webkit"], i = "AnimationFrame", s = o2["request" + i], u = o2["cancel" + i] || o2["cancelRequest" + i], c = 0; !s && c < a.length; c++)
      ...
      return (() => {
        ...
        function f(e3) {
          ...
          return s(t3) === "symbol" ? t3 : String(t3);
        }
        var v = function(e3) {
          !function(e4, t3) {
          ...
          var n2, o2, a2, v2, d2 = (a2 = h, v2 = function() {
            ...
            return function(e5, t4) {
              if (t4 && (s(t4) === "object" || typeof t4 == "function"))
                return t4;
              if (t4 !== void 0)
